...
/**
 * Created by ISMOY BELIZAIRE on 16/06/2022.
 */
...
public class MetricsDriversServicesAdapter extends FirebaseRecyclerAdapter<HistoryBooking, MetricsDriversServicesAdapter.ViewHolder> {

    private ClientProvider mClientProvider;
    private Context mContext;

    public MetricsDriversServicesAdapter(FirebaseRecyclerOptions<HistoryBooking> options, Context context) {
        super(options);
